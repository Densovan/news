...
const RightSiteNewspage = () => {
    ...
    return (
        <React.Fragment>
            <div>
                <h4 style={{ border: "1px solid #C4C4C4", borderLeft: "5px solid #373738", padding: "10px 10px 10px 10px", }}>Most Popular</h4>
            </div>
                ...
                {des.map((res, index) => {
                    return (
                        <div style={{ display: " flex", marginTop: "19px" }}>
                            ...
                            <span style={{ paddingLeft: "12px", color: "#010101" }}>{res.des}</span>
                        </div>
                    )
                })}
            </div>
            ...
            <div style={{ marginTop: "30px" }}>
                <Card style={{ width: 300, backgroundColor: " #275178" }}>
                    ...
                    <span style={{ color: "#FFFFFF" }}>Get all latest content delivered to your email a few times a month.</span>
                    <div style={{ marginTop: "12px" }}><Input placeholder="Email" /></div>
                </Card>
            </div>

            {/* Lastes Jobs site */}
            <div style={{ marginTop: " 30px" }}>
                <h4 style={{ border: "1px solid #C4C4C4", borderLeft: "5px solid #042F82", padding: "10px 10px 10px 10px", }}>Lastest Jobs</h4>
                <div style={{ marginTop: "30px" }}>
